...
const serviceData = [
  {
    ...
    description: "Pemasangan instalasi listrik baru untuk rumah dan gedung sesuai standar keselamatan.",
    img: "/assets/img/services/thumb-1.jpg",
  },
  {
    name: "renovation",
    icon: <PiPaintRollerFill />,\n    title: "Perbaikan Listrik",
    description: "Perbaikan sistem kelistrikan yang rusak atau tidak berfungsi.",
    img: "/assets/img/services/thumb-2.jpg",
  },
  {
    name: "maintenance",
    icon: <PiWrenchFill />,\n    title: "Pemeliharaan Listrik",
    description: "Pemeliharaan rutin sistem listrik untuk mencegah kerusakan.",
    img: "/assets/img/services/thumb-3.jpg",
  },
  {
    description: "Konsultasi kebutuhan listrik untuk proyek baru atau renovasi.",
