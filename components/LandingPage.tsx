    ...
    <main>
      <header className="nav">
        <div className="container nav-inner">
          ...
          <Menu className="mobile-menu" aria-label="Menu" />
        </div>
      </header>

      <section className="hero">
        <div className="container hero-grid">
          <div className="hero-copy scroll-reveal" data-scroll-reveal>
      ...
      <section id="portfolio" className="section section-soft">
        <div className="container"><div className="center-heading"><span className="eyebrow">Portfolio</span><h2>Portfolio semua layanan</h2><p className="muted">Contoh area pekerjaan yang dapat ditangani oleh tim dan mitra teknisi NyalaLagi.</p></div>
      ...
      <section id="testimonial" className="section">
        <div className="container"><div className="center-heading"><span className="eyebrow">Testimonial</span><h2>Dipercaya pelanggan, dinilai dari pengalaman.</h2><div className="rating-summary"><span className="rating-stars">★★★★★</span><b>5.0</b><span className="muted">Rating pelanggan</span></div></div>
